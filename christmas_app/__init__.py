...
systemInfoObject = About(version=0.62, status='Initial Development#15.2',
                         build=20221231, version_note='continue working on customized views, and overall improvement')
